            ...
            <div className="row">
                ...
                <div className="col-md-4 col-12 ml-auto">
                    <div className="custom-control custom-checkbox my-5">
                        ...
                        <label htmlFor="breakfast" className="custom-control-label" style={{color:"white"}}>Breakfast</label>
                    </div>
                    <div className="custom-control custom-checkbox">
                        <input type="checkbox" className="custom-control-input" name="pets" id="pets" checked={pets} onChange={handleChange} />
                        <label htmlFor="pets" className="custom-control-label" style={{color:"white"}}>Pets</label>
                    </div>
                    <div className="input-group my-5">
                        <label htmlFor="size" className="mr-3" style={{color:"white"}}>Room Size </label>
